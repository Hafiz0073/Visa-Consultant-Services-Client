...
import { BsFacebook, BsDribbble, BsGithub, BsInstagram, BsTwitter } from 'react-icons/fa';
        ...
        <div>
            <footer className="footer p-10 bg-base-200 text-base-content">
                <div>
                    ...
                    <a className="link link-hover">Conference Visa</a>
                </div>
                <div>
            ...
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <p>H Consultancy. <br />Providing reliable Service since 2022</p>
                </div>
